    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-700 p-8">
      <div className="bg-white text-gray-900 rounded-lg shadow-2xl p-12 w-full max-w-5xl">
        ...
        <p className="mb-6 text-lg leading-relaxed">
          ...
          across various services and all telecom operators for the territory of
          the world on terms as detailed below –
        </p>
        ...
        <p className="mb-4 text-lg">
          <strong>Term</strong> – This B2B is valid from the Date of Signing of
          this Document and valid till one year and will be auto-renewed for
          another year if not requested and agreed for termination on or before
          one month of expiry of this document in writing by both parties.
        </p>
